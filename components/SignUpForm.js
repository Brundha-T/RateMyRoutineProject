    ...
    >
      <header className="bg-black flex justify-between items-center px-6 py-4">
        ...
        <nav className="space-x-4 text-white font-semibold">
          ...
          <a href="/about" className="hover:text-amber-300">ℹ️ About</a>
          <a href="/Admin" className="hover:text-amber-300">👨‍💼 Admin</a>
        </nav>
      </header>

      <h1 className="text-4xl text-center mt-10 mb-6 text-yellow-100 font-semibold">Sign Up</h1>
